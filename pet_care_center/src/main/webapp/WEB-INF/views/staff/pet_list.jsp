...
<main id="main">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <form method="post" action="<c:url value='/staff/create_pet'/>" >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-row">              
              ...
              <div class="form-group col-md-6">
                <label for="service">Pet Service*: </label>
                <select id="service" name="service" class="form-control" required data-msg="Please choose the option">                  
	                  <option value="">-- select an option --</option>
	                  <option value="Shower">Shower</option>
	                  <option value="Hotel">Hotel</option>
	                  <option value="Spa and Grooming">Spa and Grooming</option>
	                  <option value="Dog/Cat Training">Dog/Cat Training</option>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" action="<c:url value='/staff/edit_pet'/>">
        <div class="modal-content">
          <div class="modal-header">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" action="<c:url value='/staff/delete_pet'/>">
        <div class="modal-content">
          <div class="modal-header">
		...
		$('table .editbtn').on('click', function(){
			...
			$.ajax({
				...
				success: function(pet) {
					...
					$('#editModal #service').val(pet.service);
				}
			})
		})
	});
