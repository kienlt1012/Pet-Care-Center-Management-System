...
<main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="staffpage_customer_list.html">Equipment</a></li>
					...
					<div class="row">
						<div class="col-sm-8" data-aos="fade-up" data-aos-delay="120">							
							<button type="submit" class="btn btn-primary" data-toggle="modal"
								...
								<i class="icofont-plus-square"> Create New Equipment</i>
							</button>				
						</div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <form method="post" action="<c:url value='/admin/create_equipment'/>" >
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Create New Equipment</h5>
          ...
          <div class="modal-body">
            <div class="form-row">              
              <div class="form-group col-md-12">
                ...
                <input type="text" name="eqName" class="form-control" id="eqName" required data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validate"></div>
              </div>
              <div class="form-group col-md-8">
                <label for="phone">Equipment Quantity:</label>
                <input type="number" name="quantity" value="0" class="form-control" id="quantity" required data-rule="minlen:4" data-msg="Please enter a valid chars" />
                <div class="validate"></div>
              </div>              
            </div>         
          </div>
          ...
          <div class="modal-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="number" name="quantity" class="form-control" id="quantity" required data-rule="minlen:4" data-msg="Please enter a valid chars" />
                <div class="validate"></div>
              </div>
              <div class="form-group col-md-6">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" action="<c:url value='/admin/delete_equipment'/>">
        <div class="modal-content">
          <div class="modal-header">
